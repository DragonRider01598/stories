...
const Read = () => {
   ...
   const data = location.state || placeholder;
   ...
   return (
      <div className="h-screen w-screen">
         ...
         <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 p-4">
            <h1 className="text-gray-100 p-0 justify-end m-0">{data.title}</h1>
            <div className="bg-transparent border-2 border-gray-600 rounded-xl shadow-lg mb-6 w-full max-w-xl p-6 lg:p-8">
               <h1 className="text-2xl lg:text-3xl font-bold mb-4 text-center text-gray-100">
                  {currentNode.data.cardTitle}
               </h1>

               <div className="flex-grow overflow-y-auto max-h-64 md:max-h-80 lg:max-h-96 mb-6">
                  <div className="text-lg lg:text-xl text-gray-300" dangerouslySetInnerHTML={{ __html: currentNode.data.cardText }} />
               </div>
               ...
               <div className="grid grid-cols-1 gap-3 mt-4 lg:grid-cols-2 lg:gap-4">
                  {connectedEdges.map((edge) => {
                     ...
                     return (
                        <button
                           key={buttonNode.id}
                           className="bg-transparent text-white border border-gray-300 text-sm lg:text-base py-2 rounded-lg shadow hover:bg-slate-700 transition duration-200"
               ...
               <div className="mt-6 lg:mt-8">
                  <div className="flex flex-col lg:flex-row justify-between gap-3 lg:gap-6">
                     <button
                        className="w-full text-sm lg:text-base bg-transparent border border-gray-500 text-gray-500 hover:text-white py-3 rounded-lg shadow hover:bg-gray-700 transition duration-200"
                     ...
                     <button
                        className="w-full text-sm lg:text-base bg-transpernt border border-red-500 text-red-500 py-3 rounded-lg shadow hover:bg-red-700 hover:text-white transition duration-200"
